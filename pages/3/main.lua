...
--导入点击事件监听接口
local OnClickListener=luajava.bindClass "net.fusionapp.core.ui.indicator.IndicatorController$OnClickListener"
...
--获取指示器
local indicator=uiManager.indicatorController
